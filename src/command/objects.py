...
class EntityManager:
    ...
    def _check_ball_racket_collision(self, ball: BallEntity, racket: RacketEntity):
        ...
        # Save ball velocity before collision for callback
        ball_velocity_before = ball.velocity.copy()
        ...
        if self.on_ball_racket_collision:
            self.on_ball_racket_collision(ball, racket, ball_velocity_before, new_velocity.copy())
